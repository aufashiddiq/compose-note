...
android {
    namespace = "com.shiddiq.composenote"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.shiddiq.composenote"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.google.accompanist:accompanist-insets-ui:0.21.4-beta")
